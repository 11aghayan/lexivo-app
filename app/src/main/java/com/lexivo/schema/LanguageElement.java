...
public abstract class LanguageElement implements ObjectContainingId {
    ...
    public LanguageElement(Text original, Text translation, String comment) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(hash, that.hash) && Objects.equals(comment, that.comment);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, hash, original, translation, lastGuessDate);
    }
